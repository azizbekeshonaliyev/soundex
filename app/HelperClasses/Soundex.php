...
class Soundex
{
    ...
    static function dmword($string, $is_cyrillic = true)
    {
        static $codes = array(
            'A' =>    array(array(0, -1, -1),
                'I' =>    array(array(0, 1, -1)),
    ...
    static function translit($string)
    {
        static $cyrill = array(
            ...
            'Ъ', 'ъ', 'Ы', 'ы', 'Ь', 'ь', 'Э', 'э', 'Ю', 'ю', 'Я', 'я','Қ','қ','Ғ','ғ','Ў','ў','Ҳ','ҳ'
        );

        static $latin = array(
            'A', 'a', 'B', 'b', 'V', 'v', 'G', 'g', 'D', 'd', 'E', 'e', 'Yo', 'yo', 'J', 'j', 'Z', 'z',
            'I', 'i', 'Y', 'y', 'K', 'k', 'L', 'l', 'M', 'm', 'N', 'n', 'O', 'o', 'P', 'p', 'R', 'r',
            'S', 's', 'T', 't', 'U', 'u', 'F', 'f', 'X', 'x', 'S', 's', 'Ch', 'ch', 'Sh', 'sh', 'Sch', 'sch',
            '\'', '\'', 'Y', 'y',  '\'', '\'', 'E', 'e', 'Yu', 'yu', 'Ya', 'ya','Q','q','G\'','g\'','O\'','o\'','H','h'
        );

        $string = str_replace($cyrill, $latin, $string);
        return $string;
    }
}